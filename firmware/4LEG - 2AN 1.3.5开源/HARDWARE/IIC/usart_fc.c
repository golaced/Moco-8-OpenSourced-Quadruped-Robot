...
void data_per_uart3(u8 sel)
{
  ...
  vs32 _temp32;
	cnt_reg=leg_pi_cnt;
	SendBuff3[leg_pi_cnt++]=0xAA;
	SendBuff3[leg_pi_cnt++]=0xAF;
	switch (sel){
	case 0:
	SendBuff3[leg_pi_cnt++]=0x01;
	SendBuff3[leg_pi_cnt++]=0;
	
	SendBuff3[leg_pi_cnt++]=BYTE0(vmc_all.param.control_mode_all);
	
	_temp=vmc_all.att[0]*10;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
  _temp=vmc_all.att[1]*10;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
	_temp=vmc_all.att[2]*10;
	...
	_temp=nav.spd_b[0]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
  _temp=nav.spd_b[1]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
	_temp=nav.spd_b[2]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
	
	_temp=vmc_all.param.encoder_spd[L]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
  _temp=vmc_all.param.encoder_spd[R]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
	_temp=vmc_all.att_rate[YAWr]*100;
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp);
	
	_temp32=nav.pos_n[Xr]*100;
	SendBuff3[leg_pi_cnt++]=BYTE3(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE2(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp32);
	_temp32=nav.pos_n[Yr]*100;
	SendBuff3[leg_pi_cnt++]=BYTE3(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE2(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp32);
	_temp32=nav.pos_n[Zr]*100;
	SendBuff3[leg_pi_cnt++]=BYTE3(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE2(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE1(_temp32);
	SendBuff3[leg_pi_cnt++]=BYTE0(_temp32);
	...
	SendBuff3[cnt_reg+3] =(leg_pi_cnt-cnt_reg)-4;
	for( i=cnt_reg;i<leg_pi_cnt;i++)
		sum += SendBuff3[i];
	SendBuff3[leg_pi_cnt++] = sum;
}
