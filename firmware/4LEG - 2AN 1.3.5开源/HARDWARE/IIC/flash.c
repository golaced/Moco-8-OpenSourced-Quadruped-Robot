...
vmc_all.cog_off[F]=(float)((vs16)(FLASH_Buffer[73]<<8|FLASH_Buffer[72]))/1000.;
vmc_all.cog_off[B]=(float)((vs16)(FLASH_Buffer[75]<<8|FLASH_Buffer[74]))/1000.;
vmc_all.kp_deng[FL1]=FLASH_Buffer[76];

if(vmc_all.cog_off[F]==0)
	 vmc_all.cog_off[F]=-0.006;
if(vmc_all.cog_off[B]==0)
	 vmc_all.cog_off[B]=-0.006;
if(vmc_all.kp_deng[FL1]==0||vmc_all.kp_deng[FL1]==255)
	 vmc_all.kp_deng[FL1]=16.5;


mems.Mag_Offseto.x=(vs16)(FLASH_Buffer[78]<<8|FLASH_Buffer[77]);
mems.Mag_Offseto.y=(vs16)(FLASH_Buffer[80]<<8|FLASH_Buffer[79]);
mems.Mag_Offseto.z=(vs16)(FLASH_Buffer[82]<<8|FLASH_Buffer[81]);
	
mems.Mag_Gaino.x =(float)((vs16)((FLASH_Buffer[84]<<8|FLASH_Buffer[83])))/100.;
mems.Mag_Gaino.y =(float)((vs16)((FLASH_Buffer[86]<<8|FLASH_Buffer[85])))/100.;
mems.Mag_Gaino.z =(float)((vs16)((FLASH_Buffer[88]<<8|FLASH_Buffer[87])))/100.;

vmc_all.use_ground_sensor=FLASH_Buffer[89];
...
_temp=vmc_all.cog_off[F]*1000;
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);
_temp=vmc_all.cog_off[B]*1000;
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);

FLASH_Buffer[cnt++]=BYTE0(vmc_all.kp_deng[FL1]);

_temp=(int16_t)mems.Mag_Offseto.x;
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);
_temp=(int16_t)mems.Mag_Offseto.y;
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);
_temp=(int16_t)mems.Mag_Offseto.z;
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);


_temp=(int16_t)(mems.Mag_Gaino.x*100);
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);
_temp=(int16_t)(mems.Mag_Gaino.y*100);
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);
_temp=(int16_t)(mems.Mag_Gaino.z*100);
FLASH_Buffer[cnt++]=BYTE0(_temp);
FLASH_Buffer[cnt++]=BYTE1(_temp);

FLASH_Buffer[cnt++]=BYTE0(vmc_all.use_ground_sensor);
