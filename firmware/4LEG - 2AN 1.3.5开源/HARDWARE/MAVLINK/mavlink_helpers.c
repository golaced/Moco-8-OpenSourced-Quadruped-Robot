...
MAVLINK_HELPER uint8_t mavlink_frame_char_buffer1(mavlink_message_t* rxmsg, 
                                                 mavlink_status_t* status,
                                                 uint8_t c, 
                                                 mavlink_message_t* r_message, 
                                                 mavlink_status_t* r_mavlink_status)
 ...
 * @endcode
 */
MAVLINK_HELPER uint8_t mavlink_parse_char2(uint8_t chan, uint8_t c, mavlink_message_t* r_message, mavlink_status_t* r_mavlink_status)
{
...
MAVLINK_HELPER uint8_t mavlink_parse_char1(uint8_t chan, uint8_t c, mavlink_message_t* r_message, mavlink_status_t* r_mavlink_status)
{
        /*
	  default message crc function. You can override this per-system to
	  put this data in a different memory segment
